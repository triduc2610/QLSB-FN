...
public class MainController {
    ...
    private void handlePitchManagement() {
        ...
        pitchListView.setEditAction(e -> {
            if (pitchListView.getSelectedPitchId() != -1) {
                ...
                pitchListView.showMessage("Vui lòng chọn một sân để chỉnh sửa.");
    ...
    private void handleBookingManagement() {
        ...
        bookingView.setSaveEditAction(e -> {
            if (bookingController.processEditBooking()) {// processEdit booking la luu booking sua thanh booking moi va
                                                         // xoa booking cu di
    ...
    private void handleSetting() {
        ...
        settingView.setChangePhoneAction(e -> {
            String newPhone = JOptionPane.showInputDialog(settingView, "Nhập số điện thoại mới :",
    ...
    private void handleReportManagement() {
        ...
        transactionListView.setDeleteAction(e -> {
            ...
            if (selectedId != -1) {
                int reply = JOptionPane.showConfirmDialog(null, "Xác nhận xóa ?", "Xác nhận",
        ...
        reportView.setResetPitch(e -> reportController.resetPitchSelection());
